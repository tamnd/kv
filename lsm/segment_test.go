...
func TestSegmentRoundTrip(t *testing.T) {
	...
	seg, err := writeSegment(pgr, bloomBitsPerKey, filterBloom, codecNone, sourceOf(cells))
	if err != nil {
...
func TestSegmentEmpty(t *testing.T) {
	pgr := newSegPager(t)
	seg, err := writeSegment(pgr, bloomBitsPerKey, filterBloom, codecNone, sourceOf(nil))
	if err != nil {
		t.Fatalf("writeSegment: %v", err)
	}
